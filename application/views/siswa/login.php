...
<html lang="en" class="no-js">
    ...
    <body class="login example2">
        <div class="main-login col-sm-4 col-sm-offset-4">
            <div class="logo">SILAHKAN LOGIN </div>
                
            <!-- start: LOGIN BOX -->
            <div class="box-login">
                <?=showFlashMessage();?>
                <?php echo form_open('auth/chek_siswa', 'class="form-login"'); ?>
                ...
                <fieldset>
                    ...
                    <p class="text-center">
                        <button type="submit" name="submit" class="btn btn-bricky">
                ...
                <fieldset>
                    <p class="text-center text-uppercase "><strong>Pendaftaran siswa baru klik <a href="<?=base_URL('pendaftaran');?>">disini</a></strong></p>
                </fieldset>
                </form>
            </div>
            <div class="copyright">
