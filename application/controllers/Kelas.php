...
Class Kelas extends OperatorController {
    ...
    {
        $gelombang = $this->Model_gelombang->find('id_kelas',$id);
        if (!$gelombang) {
        ...
        $update = $this->Model_gelombang->update($id, $data['input'],'id_kelas');
        if (! $update) {
    ...
    public function delete($id)
    {
        ...
        $hapus = $this->Model_gelombang->where('id_kelas',$id)->delete();
