...
Class Rekap_nilai extends OperatorController {
    ...
    function index() {
        $data['heading']    = $this->template->link('Akademik - Rekap Nilai');
        $data['menu'] = $this->menu;
        $data['sub_menu'] = $this->sub_menu;
        $this->template->load('template', 'rekap_nilai/list' ,$data);
    }
