...
Class Back_Rest extends OperatorController {
    ...
    function __construct() {
        ...
        $this->menu = "pengaturan";
        $this->sub_menu = "back-rest";
    ...
    function index() {
        $data['heading']    = $this->template->link('Pengaturan - Backup dan Restore');
        $data['menu'] = $this->menu;
        $data['sub_menu'] = $this->sub_menu;
        $this->template->load('template', 'back-rest/list' ,$data);
    }
